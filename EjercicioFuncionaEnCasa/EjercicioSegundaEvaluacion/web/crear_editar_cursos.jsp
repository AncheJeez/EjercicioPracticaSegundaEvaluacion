...
<html>
    ...
    <body>
        ...
        <div class="container mt-5">
            <h2>${curso != null ? "Editar Curso" : "Crear Curso"}</h2>

            <form action="ServletGestionCurso" method="post">

                <c:if test="${curso != null}">
                    <input type="hidden" name="nombreAntiguo" value="${curso.nombre}">
                </c:if>

                <input type="text" class="form-control" id="nombre" name="nombre"
                       value="${curso != null ? curso.nombre : ''}" required>

                <button type="submit" class="btn btn-primary">
                    ${curso != null ? "Actualizar Curso" : "Crear Curso"}
                </button>
                <a href="ServletGestionCurso" class="btn btn-secondary">Cancelar</a>
            </form>
        </div>
