...
<html>
    ...
    <body>
            ...
            <tbody>
                <c:forEach var="profesor" items="${listaProfesores}">
                    <tr>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${profesor.directiva}">Sí</c:when>
                                <c:otherwise>No</c:otherwise>
                            </c:choose>
                        </td>
                        <td>
                            <a href="ServletGestionProfesores?id=${profesor.idProfesor}" class="btn btn-warning btn-sm">
                                Editar
                            </a>

                            <a href="ServletGestionProfesores?action=borrar&id=${profesor.idProfesor}" 
                               class="btn btn-danger btn-sm"
                               onclick="return confirm('¿Estás seguro de que deseas borrar este profesor?');">
                               Borrar
                            </a>
                        </td>
                    </tr>
        ...
        <a href="ServletGestionProfesores?action=new" class="btn btn-primary btn-sm">Crear Profesor</a>
    </div>
