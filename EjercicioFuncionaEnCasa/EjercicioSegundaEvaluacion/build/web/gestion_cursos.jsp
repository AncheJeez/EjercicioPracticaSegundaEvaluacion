...
<html>
    ...
    <body>
            ...
            <tbody>
                <c:forEach var="curso" items="${cursos}">
                    <tr>
                        <td>${curso.nombre}</td>
                        <td>
                            <a href="ServletGestionCurso?action=editar&nombre=${curso.nombre}" class="btn btn-warning btn-sm">
                                Editar
                            </a>
                            <a href="ServletGestionCurso?action=borrar&nombre=${curso.nombre}" class="btn btn-danger btn-sm"
                                onclick="return confirm('¿Estás seguro de que deseas borrar este curso?');">
                                Borrar
                            </a>
                        </td>
                    </tr>
        ...
        <a href="ServletGestionCurso?action=new" class="btn btn-primary btn-sm">Crear Curso</a>
